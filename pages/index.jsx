        ...
        <div className="relative">
          ...
          <Container className="lg:pt-64 lg:pb-32 py-40">
            <div className="flex flex-wrap justify-center -mx-8">
              <div className="w-full px-8 text-center lg:w-6/12 xl:w-6/12 lg:text-left">
                <h1 className="text-4xl font-semibold leading-tight text-white lg:text-5xl lg:ml-14 xl:ml-0">
                  Mention Confess
                </h1>
                ...
                <div className="flex flex-wrap justify-center mt-10 xl:justify-start">
                  <Button
                    variant="solidYellow"
                    href="/kirim-menfess"
              ...
              <div className="bg-[#EAB308] mt-12 xl:mt-0 rounded-lg flex justify-center">
                <Image
                  width={300}
                  height={300}
                  alt="Hero"
            ...
            <div className="flex flex-wrap items-center -mx-10">
              <div className="w-full px-4 lg:w-6/12 lg:px-10 lg:mt-10">
                <div className="relative sm:p-10 w-full">
                  <div className="absolute lg:flex top-[-15px] sm:top-5 left-5 sm:left-[5px] z-[-1] w-64 h-64 bg-blue-100 shadow-lg" />
                  <div className="absolute lg:flex bottom-[-35px] right-[5px] z-[-1] w-64 h-64 bg-blue-500 rounded-full shadow-lg" />
                  <div className="bg-[#FFB1A3] rounded-lg shadow-xl flex items-center justify-center">
                    <Image
                      alt="Intro"
                      src="/Intro.png"
                      width="300"
          ...
          <Container>
            <div className="flex flex-wrap items-center -mx-6">
              ...
              <div className="order-1 w-full px-6 mb-10 xl:order-2 lg:w-6/12 lg:mx-0 lg:mb-0 ">
                <div className="flex items-center justify-center bg-[#1E90FF] rounded-lg shadow-lg">
                  <Image
